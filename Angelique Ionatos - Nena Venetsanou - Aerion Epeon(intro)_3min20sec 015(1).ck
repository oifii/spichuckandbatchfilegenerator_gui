...
string filename;
"D:/oifii-org/httpdocs/ns-org/nsd/ar/cp/audio_spi/spichuckandbatchfilegenerator_gui/Angelique Ionatos - Nena Venetsanou - Aerion Epeon(intro)_3min20sec 015.wav" => filename;
filename => buf.read;
chout <= IO.newline();
<<<filename>>>;
// set the gain
