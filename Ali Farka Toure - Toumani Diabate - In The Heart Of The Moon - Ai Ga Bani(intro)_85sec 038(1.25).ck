...
string filename;
"D:/oifii-org/httpdocs/ns-org/nsd/ar/cp/audio_spi/spichuckandbatchfilegenerator_gui/Ali Farka Toure - Toumani Diabate - In The Heart Of The Moon - Ai Ga Bani(intro)_85sec 038.wav" => filename;
filename => buf.read;
chout <= IO.newline();
<<<filename>>>;
// set the gain
